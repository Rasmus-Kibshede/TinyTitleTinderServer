...
export const createAddress = async (req: Request, res: Response) => {
    ...
    res.status(response.success ? 200 : Number(response.error.statusCode)).send(response.success ? {success: response.success, data: response.result.data} : {success: response.success, message: response.error.message});
};
...
export const deleteAdress = async (req: Request, res: Response) => {
    ...
    res.status(response.success ? 201 : Number(response.error.statusCode)).send(response.success ? {success: response.success, data: response.result.data} : {success: response.success, message: response.error.message});
};
